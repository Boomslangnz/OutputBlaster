...
{
	INT_PTR OutputBase = helpers->ReadIntPtr(0x235F3C8, true);
	INT_PTR OutputBaseA = helpers->ReadIntPtr(OutputBase + 0x20, false);
	INT_PTR OutputBaseB = helpers->ReadIntPtr(OutputBaseA + 0x60, false);
...
void InitialD0V211::OutputsGameLoop()
{
	if (!init)
	{
		Outputs = CreateOutputsFromConfig();
		m_game.name = "Initial D Arcade Stage 0 Version 2.11";

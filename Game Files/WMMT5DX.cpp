...
{
	UINT8 outputdata = helpers->ReadByte(0x1C2F4F1, true);
	UINT8 outputdata2 = helpers->ReadByte(0x1C2F4F2, true);
	float FFB1 = helpers->ReadFloat32(0x1C02750, true);
	float FFB2 = helpers->ReadFloat32(0x1C02754, true);
	float FFB3 = helpers->ReadFloat32(0x1C02758, true);
	float FFB4 = helpers->ReadFloat32(0x1C0275C, true);

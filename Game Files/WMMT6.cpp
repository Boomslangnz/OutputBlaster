...
{
	UINT8 outputdata = helpers->ReadByte(0x1E60691, true);
	UINT8 outputdata2 = helpers->ReadByte(0x1E60692, true);
	float FFB1 = helpers->ReadFloat32(0x1E3C610, true);
	float FFB2 = helpers->ReadFloat32(0x1E3C614, true);
	float FFB3 = helpers->ReadFloat32(0x1E3C618, true);
	float FFB4 = helpers->ReadFloat32(0x1E3C61C, true);
...
void WMMT6::OutputsGameLoop()
{
	if (!init)
	{
		Outputs = CreateOutputsFromConfig();
		m_game.name = "Wangan Midnight Maximum Tune 6";

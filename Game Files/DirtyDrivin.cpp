...
static int WindowsLoop()
{
	...
	Outputs->SetValue(OutputLeftIndicator1, (LeftIndicator1 / 4098) * 100.0);
	Outputs->SetValue(OutputLeftIndicator2, (LeftIndicator2 / 4098) * 100.0);
	Outputs->SetValue(OutputLeftIndicator3, (LeftIndicator3 / 4098) * 100.0);
	Outputs->SetValue(OutputLeftIndicator4, (LeftIndicator4 / 4098) * 100.0);
	Outputs->SetValue(OutputRightIndicator1, (RightIndicator1 / 4098) * 100.0);
	Outputs->SetValue(OutputRightIndicator2, (RightIndicator2 / 4098) * 100.0);
	Outputs->SetValue(OutputRightIndicator3, (RightIndicator3 / 4098) * 100.0);
	Outputs->SetValue(OutputRightIndicator4, (RightIndicator4 / 4098) * 100.0);
	Outputs->SetValue(OutputFogLight1, (FogLight1 / 4098) * 100.0);
	Outputs->SetValue(OutputFogLight2, (FogLight2 / 4098) * 100.0);
	Outputs->SetValue(OutputFogLight3, (FogLight3 / 4098) * 100.0);
	Outputs->SetValue(OutputFogLight4, (FogLight4 / 4098) * 100.0);
	Outputs->SetValue(OutputSpeaker1, (Speaker1 / 4098) * 100.0);
	Outputs->SetValue(OutputSpeaker2, (Speaker2 / 4098) * 100.0);
	Outputs->SetValue(OutputSpeaker3, (Speaker3 / 4098) * 100.0);
	Outputs->SetValue(OutputLargeDials, LargeDials * 100.0);
